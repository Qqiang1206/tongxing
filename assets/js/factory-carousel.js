(function (global) {
  function initFactoryCarousel() {
    ...
    var dots = root.querySelectorAll('[data-factory-dot]');
    var prevBtn = root.querySelector('[data-factory-prev]');
    var nextBtn = root.querySelector('[data-factory-next]');
    var current = 0;
    var timer = null;
    var interval = 7000;
    var touchStartX = 0;
  ...
  global.TXAM.initFactoryCarousel = initFactoryCarousel;
